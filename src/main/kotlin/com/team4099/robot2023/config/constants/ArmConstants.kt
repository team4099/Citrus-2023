...
object ArmConstants {
  object PID {
    val NEO_KP = 0.1.volts / 1.degrees  // TODO: Taken directly from 1678's code but we should tune them.
    ...
    val ARM_KS = 0.2.volts // TODO: We should tune these feedforward values because they don't seem to exist in 1678's code, so these constants are taken from our ground intake implementation.
